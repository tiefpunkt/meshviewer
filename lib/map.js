  ...
  function (ClientLayer, LabelsLayer, d3, L, moment, LocationMarker, rbush) {
    ...
    var AddLayerButton = L.Control.extend({
        ...
        onAdd: function () {
          ...
          button.textContent = ""
          button.setAttribute("data-tooltip", "Add another map layer provider")
    ...
    var LocateButton = L.Control.extend({
        ...
        onAdd: function () {
          ...
          button.textContent = ""
          button.setAttribute("data-tooltip", "Locate me and show my position on the map")
    ...
    var iconAlert   = { color: "#D43E2A", fillColor: "#D43E2A", radius: 6, fillOpacity: 0.8, opacity: 0.8, weight: 2, className: "stroke-first" }
