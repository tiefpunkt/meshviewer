define(["map/clientlayer", "map/labelslayer",
  ...
  function (ClientLayer, LabelsLayer, d3, L, moment, LocationMarker, rbush) {
    ...
    var iconLost    = { color: "#D43E2A", fillColor: "#D43E2A", radius: 3, fillOpacity: 0.5, opacity: 0.8, weight: 1, className: "stroke-first" }
    var iconAlert   = { color: "#D43E2A", fillColor: "#D43E2A", radius: 3, fillOpacity: 0.5, opacity: 0.8, weight: 2, className: "stroke-first" }
    ...
    return function (config, linkScale, sidebar, router, buttons) {
      ...
      var labelsLayer = new LabelsLayer({maxZoom: 20})
