...
*/
  return function(config, el, router, d) {
    ...
    attributeEntry(attributes, "Feinstaub PM2.5",  d.statistics.pm25_avg)
    attributeEntry(attributes, "Feinstaub PM1.0",  d.statistics.pm10_avg)
    attributeEntry(attributes, "Temperatur",  d.statistics.temperature + " °C")
    attributeEntry(attributes, "Luftfeuchtigkeit",  d.statistics.humidity + " %H")
