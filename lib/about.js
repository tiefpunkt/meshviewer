define(function () {
  return function() {
    this.render = function (d) {
      ...
      s += "<p>Copyright (C) Nils Schneider & "
      s += "<a href=\"https://github.com/freifunkMUC/meshviewer/graphs/contributors\">"
      s += "others</a></p>"
      ...
      s += "https://github.com/tcatm/meshviewer</a>.</p>"

      s += "<p>The current source code with modifications for Freifunk München "
      s += "can be found at <a href=\"https://github.com/freifunkMUC/meshviewer\">"
      s += "https://github.com/freifunkMUC/meshviewer</a>.</p>"
