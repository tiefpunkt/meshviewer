define(["chroma-js", "virtual-dom", "numeral-intl", "filters/genericnode", "vercomp"],
  ...
  return function (config, filterManager) {
    ...
    var siteCodeTable = document.createElement("table")
    siteCodeTable.classList.add("proportion")
    ...
    self.setData = function (data) {
      ...
      var siteCodeDict = count(nodes, ["nodeinfo", "system", "site_code"])
      ...
      fillTable(siteCodeTable, siteCodeDict.sort(function (a, b) { return b[1] - a[1]  }))
    ...
    self.render = function (el) {
      ...
      h2 = document.createElement("h2")
      h2.textContent = "Site Code"
      el.appendChild(h2)
      el.appendChild(siteCodeTable)
