...
function (chroma, Map, Sidebar, Tabs, Container, Meshstats, Linklist,
  ...
  return function (config, router) {
    ...
    hostnameFilter.addRefresh(function(filter){
    ...
    sidebar.add(tabs)
    var tabOverview = tabs.add("Aktuelles", overview)
    var tabNodelist = tabs.add("Knoten", nodelist)
    tabs.add("Verbindungen", linklist)
    tabs.add("Statistiken", statistics)
    var tabAbout = tabs.add("Über", about)
